	...
	public void handleMessage(final Message msg) {
		...
		switch (msg.what) {
			...
			case MSG_CAPTURE_STILL:
				thread.handleCaptureStill((String)msg.obj);//这里修改代码
...
//			mSoundPool.play(mSoundId, 0.2f, 0.2f, 0, 0, 1.0f);	// play shutter sound
			try {
//				Log.i(TAG, "handleCaptureStill: "+mWeakCameraView.get());
//				Log.i(TAG, "handleStartPreview: "+mWidth+"高度"+mHeight);
				...
				Log.i(TAG, "handleCaptureStill: "+e);
				callOnError(e);
			}
		}
